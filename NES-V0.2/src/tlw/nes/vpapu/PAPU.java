...
//	private SourceDataLine line;
	...
	private boolean userEnableDmc = true;

	private int masterFrameCounter;
	private int derivedFrameCounter;
	...
	private int smpSquare1,smpSquare2,smpTriangle,smpNoise,smpDmc;
	private int accCount;
	private int sq_index, tnd_index;

	// DC removal vars:
	private int prevSampleL = 0, prevSampleR = 0;
	private int smpAccumL = 0, smpAccumR = 0;
	private int smpDiffL = 0, smpDiffR = 0;

	// DAC range:
	private int dacRange = 0;
	...
	// Stereo positioning:
	private int stereoPosLSquare1;
	private int stereoPosLSquare2;
...
//		}
	...
	public void clockFrameCounter(int nCycles){
		...
		if(frameIrqEnabled && frameIrqActive){
			nes.getCpu().requestIrq(CPU6502.IRQ_NORMAL);
		}
	...
	protected void frameCounterTick(){
		derivedFrameCounter++;
	...
	protected synchronized void setSampleRate(int rate, boolean restart){
...
//	}
	...
	protected void setPanning(int[] pos){
...
//	}
	...
	protected void updateStereoPos(){
	...
	protected void initLengthLookup(){
	...
	protected void initDmcFrequencyLookup(){
	...
	protected void initNoiseWavelengthLookup(){
	...
	public boolean isUserEnableDmc() {
		return userEnableDmc;
	}
	public void stuff(){
		// Sound stuff:
