...
import tlw.nes.NES;
import tlw.nes.Scale;
import tlw.nes.intf.IBufferView;

public class BufferView extends JPanel implements IBufferView{
	private static final long serialVersionUID = 2164503093141895069L;
	// Scale modes:
	...
	public boolean useHWScaling(){return useHWScaling(scaleMode);}
