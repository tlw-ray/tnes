...
public class CpuInfo{
	...
	//CPU Memory Map
	public static final int MM_UPPER_BANK_OF_CARTRIDGE=		0x10000;		//Upper Bank of Cartridge ROM
	public static final int MM_LOWER_BANK_OF_CARTRIDGE=		0xC000;			//Lower Bank of Cartridge ROM
	public static final int MM_RAM=							0x8000;			//Cartridge RAM (may be battery-backed)
	...
	private static void initOpData(){
		...
		for(int i=0;i<256;i++)opdata[i]=0xFF;
